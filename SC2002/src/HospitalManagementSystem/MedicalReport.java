...
public class MedicalReport {
    ...
    public MedicalReport(String patientID, String name, String dateOfBirth, String gender, String phoneNumber, String emailAddress, String bloodType, ArrayList<String> pastDiagnosesAndTreatment){
